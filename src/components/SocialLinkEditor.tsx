...
const platforms = [
  ...
  { value: "applemusic", label: "Apple Music", icon: Music },
  { value: "soundcloud", label: "SoundCloud", icon: Mic },
  { value: "pinterest", label: "Pinterest", icon: Camera },
  ...
  { value: "maps", label: "Ubicación / Maps", icon: MapPin },
  { value: "paypal", label: "PayPal", icon: CreditCard },
  { value: "stripe", label: "Pago / Stripe", icon: CreditCard },
  { value: "shop", label: "Tienda online", icon: ShoppingBag },
  ...
  { value: "custom", label: "Enlace personalizado", icon: Link2 },
];
